...
\newcommand{\FinalTemplateComplexRecords}{113}
\newcommand{\FinalTemplateComplexCorrect}{113}
\newcommand{\FinalExpertComplexRecords}{3}
\newcommand{\FinalExpertComplexCorrect}{0}
\newcommand{\FinalSimulatedComplexRecords}{3}
\newcommand{\FinalSimulatedComplexCorrect}{0}
\newcommand{\FinalOfficialComplexRecords}{6}
\newcommand{\FinalTemplateComplexRecall}{100.00\%}
\newcommand{\FinalOfficialComplexRecall}{0.00\%}
...
% Equal-dataset macro standard metrics in percent: token F1, BLEU, ROUGE-1,
% ROUGE-2, WixQA context recall, and WixQA factuality. The table caption carries
% the unit so individual cells remain compact.
